...
|:-----------------------------------------|:----------------------------|:--------|:---------------------------------------------------------------------------------------------------------------------------|
| field                                    | Field                       | nan     | Galactic bulge observing field number.                                                                                     |
| chip                                     | Chip                        | nan     | Chip number.                                                                                                               |
| subframe                                 | Subframe                    | nan     | Subframe number.                                                                                                           |
| id                                       | ID                          | nan     | Target identifier.                                                                                                         |
| tag                                      | Tag                         | nan     | Target classification.                                                                                                     |
...
| number_of_data_points                    | Number of data points       | nan     | Number of data points in light curve.                                                                                      |
| number_of_frames_object_is_detected      | Frames detected             | nan     | Number of frames in which the object is detected.                                                                          |
| max_significance                         | Max significance            | nan     | Significance at maximum significant point in light curve.                                                                  |
| sum_of_continuous_significance           | Sum significance            | nan     | Sum of significance of continuous significant points in light curve.                                                       |
| chi_squared_outside_search_window        | Chi squared outside window  | nan     | Chi square outside of the search window in light curve.                                                                    |
...
| dophot_id                                | DoPHOT ID                   | nan     | DoPHOT identifier.                                                                                                         |
| dophot_type                              | DoPHOT type                 | nan     | DoPHOT type.                                                                                                               |
| dophot_magnitude                         | DoPHOT magnitude            | nan     | DoPHOT magnitude.                                                                                                          |
| dophot_magnitude_error                   | DoPHOT magnitude error      | nan     | DoPHOT magnitude error.                                                                                                    |
...
| pspl_u0                                  | u_0 (PSPL)                  | nan     | The minimum angular separation between lens and source normalized by the angular Einstein radius in the fitted PSPL model. |
| pspl_source_flux                         | Source flux (PSPL)          | nan     | The source flux in the fitted PSPL model.                                                                                  |
| pspl_blending_flux                       | Blending flux (PSPL)        | nan     | The blending flux in the fitted PSPL model.                                                                                |
...
| pspl_u0_parabolic_error                  | u_0 error (PSPL)            | nan     | Parabolic error in `pspl_u0`.                                                                                              |
| pspl_u0_error_lower_limit                | u_0 lower limit (PSPL)      | nan     | Lower limit error in `pspl_u0`.                                                                                            |
| pspl_u0_error_upper_limit                | u_0 upper limit (PSPL)      | nan     | Upper limit error in `pspl_u0`.                                                                                            |
| pspl_source_flux_error                   | Source flux error (PSPL)    | nan     | Error in `pspl_source_flux`.                                                                                               |
| pspl_blending_flux_error                 | Blending flux error (PSPL)  | nan     | Error in `pspl_blending_flux`.                                                                                             |
| pspl_chi_squared                         | Chi squared (PSPL)          | nan     | The chi squared statistic of the fitted PSPL model.                                                                        |
...
| fspl_u0                                  | u_0 (FSPL)                  | nan     | The minimum angular separation between lens and source normalized by the angular Einstein radius in the fitted FSPL model. |
| fspl_rho                                 | rho (FSPL)                  | nan     | The angular source size normalized by the angular Einstein radius in the fitted FSPL model.                                |
| fspl_source_flux                         | Source flux (FSPL)          | nan     | The source flux in the fitted FSPL model.                                                                                  |
| fspl_blending_flux                       | Blending flux (FSPL)        | nan     | The blending flux in the fitted FSPL model.                                                                                |
...
| fspl_u0_parabolic_error                  | u_0 error (FSPL)            | nan     | Parabolic error in `fspl_u0`.                                                                                              |
| fspl_u0_error_lower_limit                | u_0 lower limit (FSPL)      | nan     | Lower limit error in `fspl_u0`.                                                                                            |
| fspl_u0_error_upper_limit                | u_0 upper limit (FSPL)      | nan     | Upper limit error in `fspl_u0`.                                                                                            |
| fspl_rho_parabolic_error                 | u_0 error (FSPL)            | nan     | Parabolic error in `fspl_rho`.                                                                                             |
| fspl_rho_error_lower_limit               | u_0 lower limit (FSPL)      | nan     | Lower limit error in `fspl_rho`.                                                                                           |
| fspl_rho_error_upper_limit               | u_0 upper limit (FSPL)      | nan     | Upper limit error in `fspl_rho`.                                                                                           |
| fspl_source_flux_error                   | Source flux error (FSPL)    | nan     | Error in `fspl_source_flux`.                                                                                               |
| fspl_blending_flux_error                 | Blending flux error (FSPL)  | nan     | Error in `fspl_blending_flux`.                                                                                             |
| fspl_chi_squared                         | Chi squared (FSPL)          | nan     | The chi squared statistic of the fitted FSPL model.                                                                        |
| separation_to_alert_position1            | Alert 1 separation          | pix     | Separation to alert 1 position.                                                                                            |
| alert_id1                                | Alert 1 ID                  | nan     | Alert 1 identifier.                                                                                                        |
...
| alert_id2                                | Alert 2 ID                  | nan     | Alert 2 identifier.                                                                                                        |
...
| flux_err | Flux error                  | nan     | Uncertainty in measured flux for observational epoch.                                                                                                    |
| obsID    | Observation ID              | nan     | Run number, i.e., B#.                                                                                                                                    |
| JD       | JD                          | d       | Julian Date of observational epoch.                                                                                                                      |
| fwhm     | FWHM                        | nan     | Seeing estimated from the full-width half-maximum (FWHM) in arcseconds.                                                                                  |
| sky      | Sky raw                     | ct      | Sky level in counts on raw images.                                                                                                                       |
| airmass  | Airmass                     | nan     | Airmass of observational epoch.                                                                                                                          |
| nstar    | Nstar                       | nan     | Number of resolved bright stars by probe" (it is small if there are problems on the image)."                                                             |
| scale    | Image scale                 | nan     | Numerical factor used to scale image relative to the reference image.                                                                                    |
...
| chisq    | Chi-squared                 | nan     | Chi-square of PSF fitting on the difference images. Two parameters are used in PSF fitting (χ2/dof is (/npix-2)).                                        |
| npix     | Npix                        | nan     | Number of pixels used in PSF fitting.                                                                                                                    |
| airmass1 | Cor airmass                 | nan     | Airmass calculated in the detrending code.                                                                                                               |
| ang1     | Cor angle                   | rad     | Angle relative to zenith calculated in the detrending code.                                                                                              |
| included | Included                    | nan     | Data included in fitting processes. Some data excluded due to bad quality flags.                                                                         |
